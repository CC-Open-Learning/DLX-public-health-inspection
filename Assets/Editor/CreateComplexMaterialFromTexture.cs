...
/// Fixed lines 97 and 104 which were erroneously socketing textures into the wrong storage variables. 
/// Should make a future change to automatically toggle the isEmissive variable if an emission is present
/// </summary>
